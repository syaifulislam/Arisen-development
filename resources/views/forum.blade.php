...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper row3" style="background-image:url('images/bg/arisan-1.png');background-attachment: fixed;">
    ...
    <div class="content-sea">
      <div class="content-sea2">
        ...
        <input type="text" placeholder="Cari Ruangan" name="search2" value="{{$search}}">
          <button type="submit"><i class="">Cari</i></button>
        </form>
      </div>

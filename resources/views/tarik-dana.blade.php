...
<div class="wrapper bgded overlay" style="background-image:url('images/backgrounds/01.png');">
  <section id="breadcrumb" class="hoc clear"> 
    ...
    <!-- ################################################################################################ -->
    <h6 class="heading">TARIK DANA</h6>
    <!-- ################################################################################################ -->
  </section>
</div>
<!-- ################################################################################################ -->
                ...
                <div class="content">
                  <div class="con-detail-saldo">
                    ...
                    <div class="form-tar">
                      ...
                      <form method="POST" action="request-money" enctype="multipart/form-data">
                          <input name="_token" type="hidden" value="{{ csrf_token() }}"/>
                        <input class="aktifasi-text" type="text" name="request_nominal" placeholder="Masukan Jumlah Uang">
                        <a class="inf-tar">*Minimal Penarikan Rp.10.000,00</a>
                        <input  type="submit" class="login login-submit" value="TARIK">
                      </form>
                      </div>
                    </div>
                </div>
